...
public class GameClickListener implements MouseListener {
    ...
    /*
     * Tämä metodi vastaanottaa klikkauksen ja siirtää MouseEventin
     * ja kutsuvan komponentin enhancedMouseClicked- metodille.
     * 
     ...
     * Jos arvo on 0, kutsuu metodi avaaArvollaNolla- metodia.
     * Jos arvo on suurempi kuin 0 kutsutaan avaaArvollaNollaaSuurempi- metodia.
     * Muussa tapauksessa (arvon ollessa -1) kutsutaan metodia avaaMiina.
     * 
     * Kutsun ollessa hiiren oikea näppäin, muutetaan nappulan tekstiä joko tyhjäksi,
     * huutomerkiksi(lipuksi) tai kysymysmerkiksi.
     */
     ...
     * kutsun tehneen komponentin vieressä kutsumalla metodia onkoVieressa. 
     * Jos ne sijaitsevat, tarkastetaan niiden arvo.
     * Arvon ollessa suurempi kuin 0, "avataan" nappula. Jos 
     * arvo on 0, klikataan tätä nappulaa ja aloitetaan rekursio tällä nappulalla.
     */
    ...
    /*
     * Tämä metodi tekee toimenpiteet, jos klikattu nappula oli miina.
     * Metodi asettaa klikatun miinan taustaväriksi punaisen ja tekee
     * nappulasta "klikatun." Tämän jälkeen metodi käy läpi kaikki muut nappulat
     * ja jos kyseessä on miina, "avataan" se ja asetetaan sen taustaväriksi harmaa.
     * Pelin boolean muuttuja miinaAvattu saa arvon true, eikä pelin painalluksia 
     * enää kuunnella.
     * 
    ...
    /*
     * Tämä metodi tarkistaa onko kutsun tehnyt nappula toisen nappulan vieressä.
     * Jos ne ovat vierekkäin, palautetaan true, muuten false.
     * 
